...
local vmajor, vminor = "LibSharedMedia-2.0", "$Revision: 252 $"
...
if locale == "koKR" then
	mediaTable["font"]["?? ??"] = "Fonts\\2002B.TTF"
	mediaTable["font"]["?? ??"] = "Fonts\\2002.TTF"
	mediaTable["font"]["??? ??"] = "Fonts\\K_Damage.TTF"
	mediaTable["font"]["??? ??"] = "Fonts\\K_Pagetext.TTF"
elseif locale == "zhTW" then
	-- Add 5 more system fonts which can display chinese to mediaTable.
	mediaTable["font"]["??"] = "Fonts\\FZBWJW.TTF"
	mediaTable["font"]["????"] = "Fonts\\FZJZJW.TTF"
	mediaTable["font"]["??"] = "Fonts\\FZLBJW.TTF"
	mediaTable["font"]["????"] = "Fonts\\FZXHJW.TTF"
	mediaTable["font"]["??"] = "Fonts\\FZXHLJW.TTF"
elseif locale == "zhCN" then
	-- Keep the original Founder fonts to give more choices to whoever want to customize fonts
	mediaTable["font"]["????"] = "Fonts\\ZYKai_C.ttf"
	mediaTable["font"]["??"] = "Fonts\\ZYKai_T.ttf"
	mediaTable["font"]["??"] = "Fonts\\ZYHei.ttf"
